...
export default class HubApi<DB extends BehaviorType = BehaviorType.POPUP, IB extends BehaviorType = BehaviorType.IFRAME> {
    ...
    static readonly CashlinkCurrency: typeof CashlinkCurrency;
