...
class CashlinkReceive extends Vue {
    ...
    private async claim() {
        ...
        // Set up transaction inclusion listener, so we know when the tx has been sent
        ...
        try {
            ...
            // Ignore, because Cashlink has been claimed successfully and will show up in the Wallet
        }
